...
extern class LoadQueue extends AbstractLoader
{
	 ...
	 */
	function registerLoader(The:Class<AbstractLoader>) : Void;
	/**
	 ...
	 */
	inline function addFileprogressEventListener(handler:Dynamic->Void, ?useCapture:Bool) : Dynamic return addEventListener("fileprogress", handler, useCapture);
	inline function removeFileprogressEventListener(handler:Dynamic->Void, ?useCapture:Bool) : Void removeEventListener("fileprogress", handler, useCapture);
	/**
	 * This event is fired when an individual file starts to load.
	 */
	inline function addFilestartEventListener(handler:LoadQueueFilestartEvent->Void, ?useCapture:Bool) : Dynamic return addEventListener("filestart", handler, useCapture);
	inline function removeFilestartEventListener(handler:LoadQueueFilestartEvent->Void, ?useCapture:Bool) : Void removeEventListener("filestart", handler, useCapture);
}